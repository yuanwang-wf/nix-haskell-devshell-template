(() => {
  ...
  var title = /* @__PURE__ */ prop2(isPropString)("title");

  // output/Example.Basic.Button/index.js
  ...
  var render = function(state3) {
    ...
    return button([title(label5), onClick(function(v) {
      return Toggle.value;
    })])([text(label5)]);
  };
  ...
  var handleAction = function(v) {
    return modify_2(monadStateHalogenM)(function(st) {
      var $7 = {};
      for (var $8 in st) {
  ...
  var evalQ = function(render2) {
    return function(ref2) {
      return function(q2) {
        return bind(bindAff)(liftEffect(monadEffectAff)(read(ref2)))(function(v) {
          return evalM(render2)(ref2)(v["component"]["eval"](new Query(map(functorCoyoneda)(Just.create)(liftCoyoneda(q2)), $$const(Nothing.value))));
        });
      };
    };
  };
            ...
            if (v1 instanceof Join) {
              return bind(bindAff)(liftEffect(monadEffectAff)(read(ref2)))(function(v2) {
                return bind(bindAff)(liftEffect(monadEffectAff)(read(v2.forks)))(function(forkMap) {
                  return discard(discardUnit)(bindAff)(traverse_(applicativeAff)(foldableMaybe)(joinFiber)(lookup(ordForkId)(v1.value0)(forkMap)))(function() {
                    return pure(applicativeAff)(v1.value1);
                  });
                });
              });
